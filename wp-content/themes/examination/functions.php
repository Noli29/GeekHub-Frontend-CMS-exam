...
function blog_scripts() {
	...
	wp_enqueue_style( 'blogging-google-fonts', 'https://fonts.googleapis.com/css?family=Oswald:400,300,700', false );
...
function exam_widgets_init() {
	...
	register_sidebar(array(
		...
		'id' => 'sidebar',
		'description' => esc_html__('Widgets in this area will be shown in the sidebar.', 'exam'),
	...
	register_sidebar(array(
		'name' => esc_html__('Footer A', 'exam'),
		'id' => 'footer-a',
		'description' =>  esc_html__('Widgets in this area will be shown in the middle column in the footer.', 'exam'),
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
		'before_widget' => '<div class="widget %2$s"><div class="widget-content">',
		'after_widget' => '</div><div class="clear"></div></div>'
